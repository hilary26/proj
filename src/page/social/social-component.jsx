...
const SocialPage = () => {
    return (
        ...
        <Header/>
        <h1 className="cont">
        <p>You can always reach out to us on our social media pages</p>
        </h1>
        ...
        <Link className='wall-side1' to="/instagram">
                    ...
                    <Link className='wall-side1' to="/Facebook">
                            <FacebookIcon
                            style={{
                                marginRight: "8px",
                            }}
                            />
                            <span className='nav-item'>Emerite Furnitures</span>
                        </Link>
                    ...
                    <Link className='wall-side1' to="/Twitter">
                        ...
                        <Link className='wall-side1' to="/linkedin">
                            <LinkedinIcon
                            style={{
                                marginRight: "8px",
                            }}
                            />
                            <span className='nav-item'>@emerite_furnitures</span>
                        </Link>
